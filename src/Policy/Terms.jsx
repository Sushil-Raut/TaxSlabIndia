...
const Terms = () => {
  return (
    <div className="terms-container">
      ...
      <p>
        You agree to use the website for lawful purposes and in a way that does not infringe on the rights of others or inhibit their use and enjoyment of the website. Prohibited behavior includes, but is not limited to:
      </p>
      <ul>
      ...
      <h2>Privacy</h2>
      <p>
        Your use of the website is also governed by our <a href="/privacy-policy">Privacy Policy</a>.
      </p>
      ...
      <h2>Governing Law</h2>
      <p>
        These Terms of Use are governed by and construed in accordance with the laws of Faridabad, India. Any disputes arising under or in connection with these terms shall be subject to the exclusive jurisdiction of the courts located in Faridabad, India.
      </p>

      <h2>Contact Information</h2>
      <p>
        If you have any questions about these Terms of Use, please contact us at <a href="mailto:support@ezmybiz.com">support@ezmybiz.com</a>.
      </p>
    </div>
  );
};
