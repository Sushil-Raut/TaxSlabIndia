  ...
  return (
    ...
    <div className="tax-container">
      ...
      <section className="tax-section">
        <h2>Income Tax Slabs for FY 2025-26 (AY 2026-27) - New Regime</h2>
        <ul>
        ...
        <p>
          <strong> Section 87A rebate:</strong> The rebate has been increased,
          which benefits individuals with taxable income up to ₹7 lakh.
        </p>
        <p>
          <strong> Standard deduction:</strong> Salaried individuals now receive
          a standard deduction of ₹75,000.
        </p>
        <p>
          These updates effectively reduce the tax liability for incomes up to
          around ₹12.75 lakh.
        </p>
      </section>
      <section className="tax-section">
        <h2>
          Current Income Tax Slabs for FY 2024-25 (AY 2025-26) - New Regime
        </h2>
        ...
        <p>
          <strong>Rebate under Section 87A:</strong> Individuals with income up
          to ₹7 lakh are eligible for a full rebate, resulting in zero tax
          liability.
        </p>
      </section>
      <section className="tax-section">
        ...
        <ul>
          ...
          <li>
            Standard deduction of ₹50,000 introduced in the new regime for
            salaried and pensioners.
          </li>
          <li>Highest surcharge rate reduced from 37% to 25%.</li>
          <li>New tax regime set as the default regime.</li>
          <li>
            Government aims to simplify compliance and reduce tax burden for
      ...
      <section className="tax-section">
        ...
        <ul>
          ...
          <li>
            Can switch between regimes every financial year (non-business
            income).
          </li>
          <li>
            No exemptions for HRA, LTA, 80C, 80D, home loan interest, etc.
          </li>
        </ul>
      </section>
      <section className="tax-section">
        ...
        <p>
          <strong>Rebate:</strong> Up to ₹5 lakh income was eligible for rebate
          under Section 87A.
        </p>
      </section>
      <section className="tax-section">
        <h2>
          Old Regime Tax Slabs Comparison (FY 2024-25, 2023-24, 2022-23,
          2021-22)
        </h2>
        <p>
          <strong>For Individuals below 60 years:</strong>
        </p>
        <ul>
          <li>₹0 - ₹2,50,000: Nil</li>
          <li>₹2,50,001 - ₹5,00,000: 5%</li>
        ...
        <p>
          <strong>Senior Citizens (60 to 80 years):</strong> Basic exemption up
          to ₹3,00,000.
        </p>
        <p>
          <strong>Super Senior Citizens (80+ years):</strong> Basic exemption up
          to ₹5,00,000.
        </p>
        <p>
          Old regime allows deductions like 80C (up to ₹1.5 lakh), 80D (medical
          insurance), HRA, LTA, and home loan interest under Section 24.
        </p>
      </section>
      <section className="tax-section">
        ...
        <ol>
          <li>
            Calculate total income from all heads (Salary, Business, Capital
            Gains, etc.).
          </li>
        ...
        <p>
          <strong>Note:</strong> Under the new regime, most exemptions like 80C,
          HRA, etc. are not available. Tax computation is based on gross taxable
          income minus only standard deduction and employer NPS contributions.
        </p>
      </section>
      <section className="tax-section">
        <h2>Which Regime is Better for You?</h2>
        <p>
          The choice depends on your income and the exemptions you claim. Use
          the new regime if:
        </p>
        <ul>
        ...
        <ul>
          <li>
            You claim significant deductions under 80C, HRA, 80D, home loan
            interest.
          </li>
